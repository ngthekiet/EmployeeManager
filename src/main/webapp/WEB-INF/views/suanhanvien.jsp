...
<body>
<h1 style="text-align: center; font-size: 50px">SỬA NHÂN VIÊN</h1>
<div style=" display: flex; justify-content: center">
    <form:form action="/suanhanvien/${employee.id}" method="post" modelAttribute="employee">
        <div>
            <form:label path="id">Mã NV: ${id}</form:label>
